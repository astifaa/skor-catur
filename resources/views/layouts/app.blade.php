            ...
            <main class="py-4">
                <div class="col-12">
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/home">Data Peserta</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/d_jobdes">Data Jobdes (Master)</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/d_pertandingan">Data Pertandingan</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/d_skor">Hasil Skor</a>
                    </li>
                    @guest
                    @if (Route::has('login'))
                    <li class="nav-item">
